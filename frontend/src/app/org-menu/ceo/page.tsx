...
export default function CeoPage() {
  ...
  const getRoleBadge = (role: string) => {
    ...
    if (r === "ceo" || r === "owner")
      return (
        <Badge className="bg-amber-100 text-amber-800 border-amber-300 capitalize">
    ...
    <section className="space-y-6">
      <div>
        ...
        <p className="text-sm text-slate-500 mt-1">
          View and manage C-level executives and organization owners.
        </p>
      </div>
          ...
          <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            <div className="shrink-0 space-y-1">
              <div className="flex items-center gap-2">
                ...
                <span className="inline-flex h-6 min-w-6 items-center justify-center rounded-full bg-amber-100 px-2 text-xs font-bold text-slate-900">
                  {total}
                </span>
              </div>
              <p className="hidden text-xs text-slate-900/75 xl:block">
                CEO, Owner, and Admin members of your organization.
              </p>
            </div>
            ...
            <div className="relative flex-1 px-4 lg:max-w-md">
              ...
              <Input
                ...
                className="h-12 bg-background pl-12 focus-visible:ring-amber-500"
              />
            </div>
          </div>
        </div>
        ...
        <div className="p-6">
                    ...
                    <TableCell colSpan={5} className="py-12 text-center">
                      ...
                      <p className="text-sm text-slate-500">
                        {searchQuery
                          ...
                          : "No CEO or executive members found."}
                      </p>
                    </TableCell>
                  </TableRow>
                )}
          ...
          <div className="mt-4 flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
            <p className="text-sm text-muted-foreground">
              ...
              {Math.min(startIndex + pageSize, total)} of {total} executives
            </p>

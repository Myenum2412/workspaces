...
import { UserDetailModal } from "../users/user-detail-modal";
...
export default function DashboardPage() {
  ...
  return (
    <section className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-[#0F1A18]">Dashboard</h1>
        <p className="text-sm text-[#8F9792] mt-1">Overview of your organization</p>
      </div>
